...
class Command(BaseCommand):
    def handle(self, *args, **options):
        lista_empleados = [
            Empleados(nombre='Sammy', apellido='Reyes', puesto='Desarrollador', salario=1500000, fecha_ingreso='2025-12-22', activo=True, telefono='972123485', direccion='La Paz', departamento='Desarrollo', email='sammy@gmail.com'),
